...
def _parse_textstyle(parent: ET.Element, attribute: Optional[str] = None
    ...
    for ts_el in parent.findall("textStyle"):
        ...
        if attribute is None and attr is None:
            ...
            continue
        return TextStyle(
            fontSize=_float_attr(ts_el, "fontSize", 18),
...
def _parse_furniture_el(el: ET.Element, kind: str) -> PieceOfFurniture:
    ...
    return PieceOfFurniture(
        ...
        roll=_float_attr(el, "roll", 0),
        width=_float_attr(el, "width", 0),
        depth=_float_attr(el, "depth", 0),
        height=_float_attr(el, "height", 0),
        ...
        nameYOffset=_float_attr(el, "nameYOffset", 0),
        ...
        shininess=_float_attr(el, "shininess", 0),
        ...
        sashes=[
            Sash(
                xAxis=_float_attr(s, "xAxis", 0),
                yAxis=_float_attr(s, "yAxis", 0),
                width=_float_attr(s, "width", 1),
                startAngle=_float_attr(s, "startAngle", 0),
...
def _parse_background(parent: ET.Element) -> Optional[BackgroundImage]:
    ...
    return BackgroundImage(
        image=img,
        scaleDistance=_float_attr(el, "scaleDistance", 100),
        scaleDistanceXStart=_float_attr(el, "scaleDistanceXStart", 0),
        scaleDistanceYStart=_float_attr(el, "scaleDistanceYStart", 0),
        scaleDistanceXEnd=_float_attr(el, "scaleDistanceXEnd", 0),
        scaleDistanceYEnd=_float_attr(el, "scaleDistanceYEnd", 0),
        xOrigin=_float_attr(el, "xOrigin", 0),
        yOrigin=_float_attr(el, "yOrigin", 0),
        visible=_bool_attr(el, "visible", True),
    )
...
def _parse_texture_el(tex: ET.Element) -> Texture:
    ...
    return Texture(
        ...
        xOffset=_float_attr(tex, "xOffset", 0),
        yOffset=_float_attr(tex, "yOffset", 0),
        angle=_float_attr(tex, "angle", 0),
        scale=_float_attr(tex, "scale", 1),
...
def _parse_baseboard(parent: ET.Element, attribute: str) -> Optional["Baseboard"]:
    ...
    for bb in parent.findall("baseboard"):
        if bb.get("attribute") == attribute:
            ...
            height = _float_attr(bb, "height", 10.0)
...
def xml_to_home(tree: ET.ElementTree) -> Home:
    ...
    home = Home(
        ...
        wallHeight=_float_attr(root, "wallHeight", 250),
    ...
    if pr_el is not None:
        home.printSettings = Print(
            ...
            paperWidth=_float_attr(pr_el, "paperWidth", 210),
            paperHeight=_float_attr(pr_el, "paperHeight", 297),
            paperTopMargin=_float_attr(pr_el, "paperTopMargin", 10),
            paperLeftMargin=_float_attr(pr_el, "paperLeftMargin", 10),
    ...
    if env_el is not None:
        ...
        home.environment = Environment(
            ...
            wallsAlpha=_float_attr(env_el, "wallsAlpha", 0),
            ...
            videoSpeed=_float_attr(env_el, "videoSpeed", 240),
    ...
    if comp_el is not None:
        home.compass = Compass(
            x=_float_attr(comp_el, "x", 50),
            y=_float_attr(comp_el, "y", 50),
            diameter=_float_attr(comp_el, "diameter", 100),
            northDirection=_float_attr(comp_el, "northDirection", 0),
    ...
    for cam_el in root.findall("camera") + root.findall("observerCamera"):
        ...
        cam = Camera(
            ...
            x=_float_attr(cam_el, "x", 0),
            y=_float_attr(cam_el, "y", 0),
            z=_float_attr(cam_el, "z", 1000),
            yaw=_float_attr(cam_el, "yaw", 0),
            pitch=_float_attr(cam_el, "pitch", 0),
            fieldOfView=_float_attr(cam_el, "fieldOfView", 1.0),
