...
_DEFAULT: list[CatalogEntry] = [
    ...
    CatalogEntry(
        "eTeks#doubleWindow126x123", "Double small window", "doorOrWindow", "Windows", 126, 6, 123
    ),
    CatalogEntry(
        "eTeks#doubleWindow126x163", "Double window", "doorOrWindow", "Windows", 126, 6, 163
    ),
    CatalogEntry(
        "eTeks#doubleHungWindow80x122", "Double-hung window", "doorOrWindow", "Windows", 80, 6, 122
    ),
    CatalogEntry(
        "eTeks#sliderWindow126x200", "Slider window", "doorOrWindow", "Windows", 126, 6, 200
    ),
    CatalogEntry(
        "eTeks#halfRoundWindow", "Half-round window", "doorOrWindow", "Windows", 80, 6, 40
    ),
    ...
    # Kitchen
    CatalogEntry(
        "eTeks#kitchenCabinet", "Kitchen cabinet", "pieceOfFurniture", "Kitchen", 60, 60, 90
    ),
    CatalogEntry(
    ...
    CatalogEntry(
        "eTeks#fridgeFreezer", "Fridge & Freezer", "pieceOfFurniture", "Kitchen", 60, 60, 180
    ),
    ...
    CatalogEntry(
        "eTeks#clothesWasher", "Clothes washer", "pieceOfFurniture", "Bathroom", 60, 60, 85
    ),
    # Stairs / Misc / Office
    CatalogEntry("eTeks#staircase", "Staircase", "pieceOfFurniture", "Stairs", 100, 300, 250),
    CatalogEntry(
        "eTeks#spiralStaircase", "Spiral staircase", "pieceOfFurniture", "Stairs", 120, 120, 250
    ),
    CatalogEntry(
        "eTeks#curveStaircase", "Curve staircase", "pieceOfFurniture", "Stairs", 170, 200, 250
    ),
    ...
    CatalogEntry(
        "eTeks#filledBookcase", "Filled bookcase", "pieceOfFurniture", "Office", 100, 40, 211
    ),
    CatalogEntry(
        "eTeks#electricRadiator", "Electric radiator", "pieceOfFurniture", "Misc", 60, 10, 60
    ),
...
def list_catalog(
    *,
    ...
    if query is not None:
        q = query.lower()
        items = [e for e in items if q in e.name.lower() or q in e.catalogId.lower()]
    return list(items)
